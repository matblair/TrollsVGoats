...
public abstract class View extends UIAnimScreen {
    ...
    public void wasAdded() {
        ...
        root.add(topPanel
                ...
                .add(this.horizTitle = new Group(AxisLayout.horizontal(), Style.HALIGN.left)
                		.add(new Shim(20,0))
                        .add(this.back = new Button(getIcon("back_inactive"))))
        ...
        back.layer.addListener(new Mouse.LayerAdapter() {
            ...
            public void onMouseOver(MotionEvent event) {
                back.icon.update(getIcon("back_active"));
            }

            @Override
            public void onMouseOut(MotionEvent event) {
                back.icon.update(getIcon("back_inactive"));
            }

			@Override
			public void onMouseDown(ButtonEvent event) {
                back.icon.update(getIcon("back_select"));
			}    
        });
